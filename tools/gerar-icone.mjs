...
// ----------------------------------------------------------- escrever o PNG
// O escritor mora em tools/png.mjs desde que os icones de PERFIL passaram a
// precisar do mesmo formato. Duas copias de um formato binario divergem
// caladas — a que ninguem esta olhando so gera arquivo ruim no dia em que um
// visualizador recusa.
